        ...
        <>
                ...
                <div className='col mx-auto px-2'>
                    <div className="card mx-2 my-2 " style={{ width: "18rem" }}>
                        ...
                        <div className="card-body">                        
                        <button onClick={()=> navigate({pathname:"/register-contestant"}, {state:category})} className="card-link btn-sm btn-success me-5 ms-2" ><i className="bi bi-clipboard-check fs-7"><span> Contest</span></i></button>
